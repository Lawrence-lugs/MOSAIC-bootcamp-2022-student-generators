...
@dataclass
class CurrentMirrorParams(ParamsBase):
    """
    Parameter class for current_mirror_gen
    ...
    @classmethod
    def finfet_defaults(cls, min_lch: float) -> CurrentMirrorParams:
        return CurrentMirrorParams(ntap_w=10,
                                   ptap_w=10,
                                   lch=min_lch,
                                   th_dict={
    ...
    @classmethod
    def planar_defaults(cls, min_lch: float) -> CurrentMirrorParams:
        return CurrentMirrorParams(ntap_w=10 * min_lch,
                                   ptap_w=10 * min_lch,
                                   lch=min_lch,
                                   th_dict={
