...
yaml_file = os.path.join(f'{os.environ["BAG_GENERATOR_ROOT"]}/BagModules/current_mirror_templates', 'netlist_info', 'current_mirror.yaml')


# noinspection PyPep8Naming
class schematic(Module):
    """Module for library current_mirror_templates cell current_mirror.
