...
yaml_file = os.path.join(f'{os.environ["BAG_GENERATOR_ROOT"]}/BagModules/twomos_stable_bias_templates', 'netlist_info', 'twomos_stable_bias.yaml')


# noinspection PyPep8Naming
class schematic(Module):
    """Module for library twomos_stable_bias_templates cell twomos_stable_bias.
