...
# 5. Create and place wires.
      ...
      rg0 = dsn.route_via_track(grid=r23, mn=_mn, track=_track)
      
      _mn = [r12.mn(ip0.pins['G'])[0], r12.mn(ip0.pins['D'])[0]]
      rg1 = dsn.route(grid=r12, mn=_mn, via_tag=[True, True])

      _mn = [r12.mn(ip0.pins['G'])[1], r12.mn(ip0.pins['D'])[1]]
      rg2 = dsn.route(grid=r12, mn=_mn, via_tag=[True, True])
...
# 6. Create pins.
      pout0 = dsn.pin(name='TIE', grid=r12, mn=r12.mn.bbox(in0.pins['D']))  # problem : nf == 2
