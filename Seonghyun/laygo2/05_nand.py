...
#          05) NAND(only NMOS) Layout Generator          #
...
# 5. Create and place wires.
      ...
      rout0 = dsn.route(grid=r12, mn=_mn)

      # VSS
      rvss0 = dsn.route(grid=r12, mn=[r12.mn(in0.pins['RAIL'])[0], r12.mn(in1.pins['RAIL'])[1]])
      
# 6. Create pins.
      pina0 = dsn.pin(name='A', grid=r12, mn=r12.mn.bbox(in0.pins['G']))
      pinb0 = dsn.pin(name='B', grid=r12, mn=r12.mn.bbox(in1.pins['G']))
