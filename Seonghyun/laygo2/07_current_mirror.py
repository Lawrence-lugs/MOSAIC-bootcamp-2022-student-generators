...
#          07) Current Mirror Layout Generator           #
...
# 5. Create and place wires.
      ...
      # IN
      _mn = [r12.mn(in0.pins['D'])[0], r12.mn(in0.pins['G'])[0], r12.mn(in1.pins['G'])[0]]
      rin0 = dsn.route(grid=r12, mn=_mn, via_tag=[True, True, True])

      # VSS
      rvss0 = dsn.route(grid=r12, mn=[r12.mn(in0.pins['RAIL'])[0], r12.mn(in1.pins['RAIL'])[1]])
      
# 6. Create pins.
      pin0  = dsn.pin(name='I', grid=r12, mn=r12.mn.bbox(rin0[1]))
      pout0 = dsn.pin(name='O', grid=r23, mn=r23.mn.bbox(in1.pins['D']))
