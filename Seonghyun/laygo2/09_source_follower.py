...
#          09) Source Follower Layout Generator          #
...
# 5. Create and place wires.
      ...
      # OUT
      _mn = [r23.mn(in0.pins['D'])[1], r23.mn(in1.pins['D'])[1]]
...
# 6. Create pins.
      ...
      pbias0 = dsn.pin(name='BIAS', grid=r12, mn=r12.mn.bbox(in1.pins['G']))
