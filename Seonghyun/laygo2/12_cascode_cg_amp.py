...
#          12) Common Gate Amp Layout Generator          #
...
# 3. Create instances.
      ...
      in0 = tnmos.generate(name='MN0', params={'nf': nf, 'trackswap':True})
...
# 5. Create and place wires.
      ...
      # Internal
      _mn = [r12.mn(in0.pins['D'])[0], r12.mn(in1.pins['S'])[1]]
      rint0 = dsn.route(grid=r12, mn=_mn)

      # VSS
      rvss0 = dsn.route(grid=r12, mn=[r12.mn(in0.pins['RAIL'])[0], r12.mn(in1.pins['RAIL'])[1]])
      
# 6. Create pins.
      pbias0 = dsn.pin(name='BIAS1', grid=r12, mn=r12.mn.bbox(in0.pins['G']))
      pbias1 = dsn.pin(name='BIAS2', grid=r12, mn=r12.mn.bbox(in1.pins['G']))
      pin0 = dsn.pin(name='I', grid=r12, mn=r12.mn.bbox(in0.pins['S']))
      pout0 = dsn.pin(name='O', grid=r12, mn=r12.mn.bbox(in1.pins['D']))
