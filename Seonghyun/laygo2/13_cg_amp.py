...
#          13) Common Gate Amp Layout Generator          #
...
# 3. Create instances.
      ...
      in0 = tnmos.generate(name='MN0', params={'nf': nf, 'tie':'S', 'trackswap':True})
...
# 5. Create and place wires.
      ...
      rin0 = dsn.route(grid=r12, mn=_mn)

      # VSS
      rvss0 = dsn.route(grid=r12, mn=[r12.mn(in0.pins['RAIL'])[0], r12.mn(in1.pins['RAIL'])[1]])
      
# 6. Create pins.
      pin0 = dsn.pin(name='I', grid=r12, mn=r12.mn.bbox(rin0))
