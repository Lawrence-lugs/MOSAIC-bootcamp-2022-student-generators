...
#  18) CS Amp with diode load (folded) Layout Generator  #
...
# Design Variables
cell_type = ['18_csamp_diode_folded'] 
nf_list = [2, 10]
...
# 5. Create and place wires.
      ...
      # OUT
      _mn = [r12.mn(in0.pins['D'])[0], r12.mn(in1.pins['D'])[1]]
      rout0 = dsn.route(grid=r12, mn=_mn)

      _mn = [r12.mn(in1.pins['D'])[0], r12.mn(in1.pins['G'])[0]]
      rout1 = dsn.route(grid=r12, mn=_mn)
...
# 6. Create pins.
      ...
      pout0 = dsn.pin(name='O', grid=r12, mn=r12.mn.bbox(rout0))
