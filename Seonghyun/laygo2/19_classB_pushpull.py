...
#     19) Class-B Push-Pull follower Layout Generator    #
...
# Design Variables
cell_type = ['19_classB_pushpull_follower'] 
nf_list = [2, 10]
...
# 6. Create pins.
      ...
      pvss0 = dsn.pin(name='VDD:', grid=r12, mn=r12.mn.bbox(rvss0))
      pvdd0 = dsn.pin(name='VSS:', grid=r12, mn=r12.mn.bbox(rvdd0))
