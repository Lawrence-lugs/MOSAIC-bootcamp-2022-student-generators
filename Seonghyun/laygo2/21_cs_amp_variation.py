...
#      11) CS Amp (variation ver.) Layout Generator      #
...
# 6. Create pins.
      pin0 = dsn.pin(name='BIAS', grid=r12, mn=r12.mn.bbox(in0.pins['G']))
      pbias0 = dsn.pin(name='I', grid=r12, mn=r12.mn.bbox(in1.pins['G']))
